...
var fightOrSkip = function() {
    ...
    if (promptFight === "" || promptFight === null) {
      ...
      // use return to call it again and stop the rest of thos function from running 
      return fightOrSkip();
    }

    //convertpromptFight to all lowercase so we can check with less options
...
// check player's health
  ...
  isPlayerTurn = !isPlayerTurn;
    ...
    if (playerInfo.money > highScore) {
        ...
        lovalStorage.setItem("name", playerInfo.name);
